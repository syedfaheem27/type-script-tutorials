...
function modifyObj(target) {
    return /** @class */ (function (_super) {
        ...
        function A() {
            ...
            _this.createdAt = new Date().toLocaleString("en-IN");
            return _this;
        }
        return A;
    }(target));
...
var ImportObj = function () {
    var _classDecorators = [modifyObj];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var ImportObj = _classThis = /** @class */ (function () {
        function ImportObj_1(name, weight) {
            this.name = name;
            this.weight = weight;
        }
        ImportObj_1.prototype.describe = function () {
            console.log("An object ".concat(this.name, " with a weight of ").concat(this.weight, " kgs."));
        };
        return ImportObj_1;
    }());
    __setFunctionName(_classThis, "ImportObj");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ImportObj = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ImportObj = _classThis;
}();
var objI = new ImportObj("TV", 23);
console.log(objI);
